...
Anlautkürzel bestehen nur aus dem Anlaut.
* **d**as → `d`
...
* `t.en.sI zr* dr-Ür .iS-er b.e-üss.e .ei .S-Y.L.e er-au.is?`
 * `dr-Ür` → `dr-ü`
 * `.S.drÜ.L.e` → `.S-Y.L.e`
