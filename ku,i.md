...
* **morg** → `mo` ! `m.og` E
* mot → `m.ot`
 * : motivation → `m.ot.iv.iO` E !!! `m.ot.iw-o`
 ...
 * nehme**n** → `;n`
    ...
    * : t**eil**nehme**n** → `:eil;n`
    * : **ü**bernehme**n** → `Ü;n`
    * : *unter*nehme**n** → `UNTER;n` !!! `UNTER.en`
    * : *vor***weg**nehme**n** → `O.w;n`
 * nehm**end** → `:ed`
    * : abnehm**end** → `.ab:ed`
 * nehme**r** → `;r`
    * : ***teil***nehme**r** → `:eil;r`
    * : *unter*nehme**r** → `UNTER;r` !!! `UNTER-er`
 * nehm**st** → `;-st`
    * : *vor*nehm**st** → `O;-st`
 * nehm***ung*** → `UNG`
 ...
 * satz → `s.az` E
    * : absatz → `.ab-s.az` ! `.ab.s.az` !!! `.ab.sa` E
    * : grundsätzlich → `gru-s.ez.L` ! `gru.s.ez.L` !!! `gru.s.L`
* setz ← sitz
* *so* → `.o` V
* sol → `s.ol`
 * : solid → `s.ol.id`
 ...
 * `.emp-f.i-L.e` !i! `.emp-i.L.e`
 * `.emp.eng-er` !e! `.emp-er`
 * `ds,kri.ir-UNG` !i! `ds-i.ir-UNG`
 * `.emp-fu` !u! `.emp-u`
 ...
 * `.S.ür.L` !ü! `.S-ü.L`
 * `eNT,wi.l.l.ed-er` !i! `eNT-i.l.ed-er` !-! `eNT-i.d-er`
 ...
 * `.emp.ang` !a! `.emp-a`
* `I .S.ür eNT.icht .auch-t .an.n.äh.d u-er-er b.st*, I .ir fra.fru M.T-er, h kr-s, E-t-lt-t.`
 * `.S.ür` !ü! `.S-ü`
 * `.an.n.äh.d` !!! `.an;r.d`
 * `E-t-lt-t` ! `E-t-lt t`
...
* `I>U.en w.ek.st.en i .äm.L ;r .az z.i-L b.e>schr.`
