 ...
 * **sucht** su
    ...
    * **sücht** `sÜ` = `s.ücht`
       ...
       * eigen**sücht****ig** `.eig.sÜ.i` = `.eig.sücht.i` * eigens**ü**cht**ig** `.eig-Ü.i` ≠ eigen**nütz****ig** ! `.eig.ücht.i`
* *siedel* `s.i-l`
* sind ← sein
* (sist) `s.i+st`
 ...
 * **v**ent `w` ! `w.et` E
    ...
    * : evtl. `.e-v-t-l`
    * : *in****v***entar `I>w.ar` ! `IN.w.et.ar` (E) ~ `IN-tar`
    * : *in***v**entur `I>w-UR` ! `IN.w.et.UR` (E) ~ `IN-tUR`
