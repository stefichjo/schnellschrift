...
* ~~hal~~t `('t)` : `('t)-bar` `('t)-bar.T` `('t)-l.o` `('t)-ed` `G't` `.an-t` `.an-t-ed` `AU-t` `.S-t` `N-t` `er-t` `IN.'t` `.in-t` `ach-t-ig` `.aus,(-t)` `rÜ-t-l.o` `sa.E't` `E't-is` `('t).I` `('t):wr` `dU ('t)` `er ('t)` `.ir ('t)-et` `sI ('t)`
  ...
  * ~~häl~~t `('t)`
  * : hielt `hit`
    * ~ *hielt* `hi` `.ab,hi` `b.e,hi` `eNT,hi` `(er)hi` `UNTER,hi` `u-rÜ,hi`
...
* **pa**r `pa`
  ...
  * : *re***pa**ratur `(re)pa-UR` ! `(re)pa-UR` E
...
* **schreib** `.eib`
  * **schrieb** `.ib`
  * **schrift** `.ift`
    * -~~schrift~~- `i` : `.ab,i` `ku,i` `schn,i` `UNTER,i` `Z,i`
...
* **sul** `su`
  ...
  * **sult** `sut`
    ...
    * : *re***sult**ier `r.e-sut-ir` ~ `re-su.ir`
    * : *re***sult**at `r.e-sut-at` ~ `re-su.at`
* **sum** `su`
  * : **kon**<i></i>**sum** `ko-su`
...
* volv `v.ow`
  * : *re*volver `re-w.ow-er`
  * volt `v.ot`
    * : *re*volte `re-wot.e`
  * *vol<b>*u*</b>t* `u`
    * : e*vol<b>*u*</b>t*ion `.e,u-O`
    * : *re**vol<b>*u*</b>t*ion `r.e-u-O`
    * : **konter***re**vol<b>*u*</b>t*ion `ko-t-er,re-u-O`
* **v**on `v` V
...
* ***zieh*** `.ih` : `be-ih`
  ...
  * ***zug*** `.ug` : `.ug.ug`
    * ***züg*** `.üg` : `.üg.e` `.üg.el` `.üg.i`
      * ~~z~~**ü**~~g~~ `Ü` : `gr-Ü.ig` `ach-Ü.el-er` `O-Ü.L`
* ***ziel*** `.il`
* zi~~em~~ `z.i` : `z.i-L`
* **zil** `.il` : `ko.il`
* **zip** `.ip` : `ko.ip.ir`
