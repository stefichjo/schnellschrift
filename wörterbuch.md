...
### Nützliche Kürzel (für Fortgeschrittene)
...
* arbeit `.ab.T` (BSA)
  ...
  * arb<b>*eit*</b> `(T)`
    ...
    * arb<b>*eit*</b>slos `(T)-l.os`
      * ~~arbeit~~slos `(l.os)`
        * : ~~arbeit~~slos**ig**<i></i>***keit*** `(l.os).T`
...
* artikel `.at.ik.el` (BSA)
  ...
  * : **be**<i></i>**darf**sartikel `b.da.at.ik.el` (BSA)
  * ~~art~~ikel `(.ik.el)`
    * .~~art~~<i></i>~~ik~~el. `(.el)`
...
* **frag** `fra` : `fra-e` `fra.ed` `fra.L` `fra.l.os` `G-fra` `.an.fra` `ach.fra` `rÜ.fra` `I b.e-fra-t-en` `sI fra` `sI fra-t.e` `sI fra.t-en`
* **frau** `frau`
* ~~fr~~ei `(.ei)`
* fre~~md~~ `(fr.e)`
...
* geb `g.eb` : `g.eb-er` `.an.g.eb-er` `ra.g.eb-er`
  * ~ **geb** `g` : `G-g` `G-g.H` `.ab.g` `b.g.H` `er.g` `ach.g` `Ü.g` `E-g-s` `E-g.L` `u-rÜ:g` `n.S.ag.g`
...
* **geh** `g` : `g.ed` `.S.g` `N.g.ed` `eNT.g` `E-g` `O-Ü.g` `Z-gru.g`
  ...
  * **gang** `ang` : `ang.bar` `.S.ang` `N.ang` `G-ang` `E-ang` `E-l.or.ang` `GR-Ü.ang` `rÜ.eng.i` `UN-E-eng.L` `O-eng.er` `UN-z.eng.L`
* **geist** `g.ei`
...
* ***haus*** `.aus` : `ra.aus` `.im.aus.e` `v.aus.S` `kra.aus` `sta.aus`
...
* **hö**r `hö`
  * : **be**<i></i>**hö**rde `b.hö.d.e` » `b.hö` ! **be**<i></i>hörde `b.h.öd.e` (BSA)
    * : *gemein*de**be**<i></i>**hö**rde `(N)-d.e-b.hö.d.e` » *gemein*de~~be~~**hö**r~~d~~<i></i>e `(N)-d.e-hö-e` ! *ge*m<b>*ein*</b>debehörde `G-Nd.e-b.h.öd.e`
* **hundert** `hu` BSA
  * : X `3.hu` `5,hu` `hu.FT`
...
* **lieg** `li` : `.an,li` `b.ei,li-ed` `er,li` `UNTER,li`
  ...
  * **leg** `l` : `l-t.e` `.ab.l` `b.e-l` `dar-AU.l` `Ü.l` `E-l` `E-l.H` `zr.l-UNG` `f.est-l` `gru.l.ed` `.ar.l` `G-l.H` `.an.l.H`
...
* ~~nehm~~ : `(.e)` `.an.bar` `.an.L.T` `(T),(er)` `(.eil),(en)` `(.eil),(er)` `Ü.en` `UNTER.en` `E-L` `O-L` `O-w,(en)` `O-l.ib,(en)` `wa,(en)` `wa,(UNG)` `IN.auf.en`
  * ! nehm `n.em` : `O-n.em`
...
* ~~pol~~**it** `it` : `it.i` `it.i-er` `.auss.it.i` `.in.it.i`
...
* ***pon*** `.on` : `ds.on.ir` `kom.on.ir` `tra.on.ir`
  ...
  * ***pos*** `.os`
    * : ***pos***<i></i>it*ion* `.os.iO` ~ `pos`
      * : *dis*<i></i>***pos***<i></i>it*ion* `ds.os.iO` » `ds.os`
    * : ***pos***<i></i>itiv `.os.iv` ~ `po.iv`
...
* schlacht ← schlag
* schlaf `schl.af`
* ***schlag*** `.ag` : `.ag-er` `G-ag` `.an.ag` `AU.ag` `ra.ag` `E-an.ag`
...
* ***tret*** `.et` STS
  * : *ver*<i></i>***tret***<i></i>er `E-et-er` × `E-er`
  * ! tret `tr.et` : `G-tr.et`
