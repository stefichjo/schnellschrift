...
* ~~f~~ang `(ang)` : `N.ang`
  * ! fang `f.ang`
  * ~ -**fang**- `fa` : `.an.fa` `b.e-fa` `.um.fa`
  * * -~~f~~a~~ng~~- `a` : `.emp-a`
  * × ~~fang~~ : `.um:eich`
  * ~~f~~äng `(.eng)`
    * (fäng) ! `f.eng` `E.eng.L`
    * ~ -f~~äng~~- `f` : `.an.f-er` `G-f.is`
    * × ~~fäng~~ : `.emp`
  * ~~f~~ing `(.ing)`
    * ! (fing) `f.ing`
    * * ~~f~~i~~ng~~ `.emp-i`
...
* ~~masch~~in `(.in)`
  * : ~~masch~~ine `(.in).e` ! `m.asch.in.e` » `m.asch` E
  * : ~~masch~~inell `(.in).ell` ! `m.asch.in.ell` » `m.asch.ell` E
* <b>*mass*</b> `ass` E
  * : <b>*mass*</b>e `ass.e`
