...
* ***biet*** `.it` BSA
 * : ***biet***end `.it.ed` (BSA)
 * : an*er****biet*** `.an.er.it` (BSA) @anerbiet?
 * : *ge****biet*** `G-it` (BSA)
...
* **dien** `di` E
 * : **dien**er `di-er` ! `di.er`
 * : **dien***lich* `di.L` ! `d.in.L` E ≠ **dienst***lich*
 * : be**dien** `b.e,di`
 * : *ver***dien** `E,di` E
 * **dienst** `di` E
    * : **dienst***lich* `di.L` E
...
* **dürf** `dÜ` E
 * : be**dürf** `b.e-dÜ`
 * : be**dürf*****nis*** `b.e-dÜ.is` * bed**ü**rf***nis*** `b.e-Ü.is` ~ `b-Ü.is`
 ...
 * **sucht** su
    ...
    * **sücht** `sÜ` = `s.ücht`
       ...
       * eigen**sücht****ig** `.eig.sÜ.i` = `.eig.sücht.i` * eigens**ü**cht**ig** `.eig-Ü.i` ! `.eig.ücht.i` ≠ eigen**nütz****ig**
* *siedel* `s.i-l`
* sind ← sein
* (sist) `s.i+st`
