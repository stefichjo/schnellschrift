...
* **gast** `ga`
  * **gäst** `gä`
* ge `g.e` : `g.e-l.og.e` `g.e-l.og.I` `g.e-m.etr.I` `g.e-m.etr.i`
...
* **geh** `g` : `g.ed` `.S.g` `N.g.ed` `eNT.g` `E-g` `O-Ü.g` `Z-gru.g`
  ...
  * **gang** `ang` : `ang.bar` `.S.ang` `N.ang` `G-ang` `E-ang` `E-l.or.ang` `gr.ez-Ü.ang` `rÜ.eng.i` `UN-E-eng.L` `O-eng.er` `UN-z.eng.L`
* **geist** `g.ei`
...
* **gr**oß `gr` BSA
  ...
  * : X `gr.art-ig`
  * : **größ**e `grö.e` BSA
    * : X `grö.er` `.am.grö-t` `grö.e` `(er) grö-t.e` `(E)grö.er`
* **grund** `gru` BSA
...
* *in* `IN` V
  * : *dar*<i></i>*in* `dar.IN` * *dar*<i></i>**i**n `dar-i`
  * *in*- `(I)`
    * : *in*s `(I)-s` S ! `IN.s`
  * .*in*. `(I)`
  * inn `.in`
...
* leg `l.eg` : `l.eg.ed.e`
  ...
  * lig : `l.ig:ma.FT`
    ...
    * : *intell*igenz `IN.t.ig.ez` × `IN.t.ez`
    * l~~i~~ `l` : `l.ir`
  * lekt `l.ekt` : `l.ekt-iO` `l.ekt-or` `l.ekt-ür.e` `IN.t.ekt` `IN.t.ekt-ell` `ko.ekt-iO` `ko.ekt-iv`
* lehn `l.en`
  * × ab*ge*~~lehnt~~ : `.ab.G`
* lehr `l.er`
  * ~~l~~**ehr**er `(er)-er` ~ `er-er`
  * ~~lehr~~*ling* `(.ing)` ! `l.ing`
* **leicht** `l.ei`
* leih `l.eih`
...
* sucht ← siech
* **sul** `su` : `ko-su`
  * sult `sut` : `ko-sut-ir` `ko-sut-iO` `re-su.ir` `re-su.at`
* **sum** `su` : `ko-su` `ko-su.ir`
  * : **kon**<i></i>**sum***ent* `ko-su.eNT`
* **summ** `su`
* *sund* `.und` : `G-und`
...
* volv `v.ow`
  ...
  * *vol<b>*u*</b>t* `u`
    ...
    * : *re*<i></i>*vol<b>*u*</b>t*ion `r.e-u-O`
