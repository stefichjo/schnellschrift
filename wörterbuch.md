...
* **blut** `blu`
 * **blüt** `blü`
    * : **heiß****blüt****ig** `h.ei,blü.i` * **heiß**bl**ü**t**ig** `h.ei-Ü.i` ! `h.eiss-Ü.i`
    * : kalt**blüt****ig** `kat,blü.i` * kaltbl**ü**t**ig** `kat-Ü.i`
* **bod** `bo`
* börse `b.ös.e` (BSA)
 ...
 * **dukt** `du`
    * *in***dukt***ion* `(I)du-o`
    * pr**o****dukt** `(o)du` ~ `(o)dut` E
       * pr**o****dukt**iv `(o)du.iv` E
       * pr**o****dukt***ion* `(o)du.iO` E
* duld `d.ud` (BSA)
...
* **fäh** `f`
 * : **fäh****ig** `f.i`
 * : **fäh****ig***keit* `f.T` ! `f.eh.T` (BSA)
* ***f****ahr* `fa` BSA
 * : X `G-fa.Ol` `G-f.L` `UN-G,f.L` `G-f.L.T` `G-f.ed` `G-f.ed-UNG`
 * : X `UN-G.L`
 * : ***f****ahr***bar** `fa.bar` (BSA)
 * : ***f****ahr*er `fa-er` ! `far-er` BSA
 * : ***f****ahr*t `fa-t` (BSA)
 * : ab***f****ahr* `.ab.fa` (BSA)
 * : ab***f****ahr*t `.ab.fa-t` (BSA)
 * : *aus****f****ahr* `.S.fa`
 * : *er****f****ahr* `er.fa` (BSA)
 * : *ge****f****ahr* `G-fa` (BSA)
 ...
 * ***f****ähr* `f` E
    ...
    * : *unge****f****ähr* `UN.G-f`
       * *unge*~~fähr~~ `UN.G` E
    * : *unge****f****ähr**lich* `UN.G-f.L` E
    * : *will****f****ähr**ig* `:l<f.i` (BSA)
    * : *du* *er****f****ähr*st *es* `dU er.f .e` (BSA)
    * : *er* ***f****ähr*t `er f` ! `er f-t` BSA
 * ***f****uhr* `fu` BSA
    * : *aus****f****uhr* `.S.fu` (BSA)
    * : ein***f****uhr* `N.fu` (BSA)
    * : *zu****f****uhr* `Z-fu` (BSA)
 ...
 * : *sorg*fält**ig** `s.o-fet-ig` * *s****o****rg*fält**ig** `(o)fet-ig` ~ `(o)f.i` ! `s.og.fet-ig` (E)
 ...
 * fir***m*** `;m`
    * : fir***m***a `;m.a`
    * : fir***m***ament `;m.a-met` ! `f.im.a-met` > `f.im-met`
    * : **kon**fir***m***at*ion* `ko.m-o` ! `ko.f.im-o`
* **flach** `fla`
* ***flieg*** `.ig`
 * ***flog*** `.og`
 * ***flug*** `.ug`
...
* *fort* `fr` V
* form `f.om` (BSA)
 * : X `G-f.omt` `IN.iS<f.om` `f.öm.L` `UN-f.öm.i` `f.om.al` `f.om.ell` `f.om.iO` `f.om.ul.ir` `f.om.ir` `r.e-f.om` `r.e-f.om.ir` `r.e-f.om.irt.e` `r.e-f.om.iO` `r.e-f.om.or.i` `.un.i-f.om`
 * : format `f.om.at` (BSA)
 ...
 * glitt `gl.it`
* ***glied*** `.id`
 * : *mit****glied*** `M.id` * *mit*gl**ie**d `M-i`
* ***glück*** `.ük` BSA
 ...
 * ***häus*** `.äus` (BSA)
    ...
    * : *ge****häus***e `G-äus.e` ! `G-h.äus.e` (BSA)
* **heiß** `h.ei`
 * **hieß** `h.i` ! `h.iss`
* -*heit* `H` V
* helf `h.ef` (BSA)
 ...
 * : be**hö**rde `b.e-hö.d.e` » `b.e-hö` ! behörde `b.e-h.öd.e` (BSA)
    * : *gemein*debe**hö**rde `;Nd.e-b.e-hö.d.e` » *gemein*de~~be~~**hö**r~~d~~~~e~~ `;Nd.e-hö` ! *ge*m***ein***debehörde `G-Nd.e-b.e-h.öd.e`
* **hundert** `hu` BSA
 * : X `3.hu` `5,hu` `hu.FT`
 * : **jahr****hundert** `ja.hu`
* -*ial* `.iaL` BSA
 ...
 * : *dies***jähr****ig** `.is<j.i` × *dies*~~jähr~~**ig** `.is.i`
...
* **pfleg** `pfl`
* ***pflicht*** `.icht` E
 * : **haft*****pflicht*** `ha.icht` * **haft***pfl****i****cht* `ha,i`
* phon `f.on`
 * : phonetik `f.on.ik`
 * : phonet**isch** `f.on.i`
 * -**ph**on `f`
    * : grammo**ph**on `gr.am.f` ~ `gr.am.on`
    * : **tele****f**on `t.f` ! `t.el.e-f` E
    * : **tele****f**onat `t.f.at`
    * : **tele****f**onier `t.f.ir` ! `t.el.e-f.ir` E
    * : **tele****f**on**isch** `t.f.i` ! `t.el.e-f.i` E
* phras `fr.as`
* **phys** `fy`
...
* **plan** `pla`
 * -***plan*** `.an`
    * : **bund**es*jugend****plan*** `bu.ug.ed.an` » `bu.ug.an`
* **plant** `pla`
 ...
 * -poli***tik*** `-t-ik`
    * : **fin**anzpoli***tik*** `fi.az-t-ik` » `fi-t-ik`
 ...
 * ***schrieb*** `.ib` E
 * **schrift** `.ift` E
    * : ab**schrift** `.ab.ift` * ab*schr****i****ft* `.ab,i`
...
* ***schul*** `.ul`
 * : ***schul***e `.ul.e`
    * : ***f****ahr****schul***e `fa.ul.e` ! `fa.sch.ul.e` (BSA)
 * : ***schül***er `.ül-er`
 * : **hoch*****schul***e `ho.ul.e` * **hoch**sch**u**le `ho-u.e` » `ho-u`
* **schutz** `schu` = `.uz`
 * : umwel**t****schutz** `.um-t,.uz` * umwel**t**sch**u**tz `.um-t,u`
 * **schütz** `schÜ`
* schwed `schw.ed`
 ...
 * sah `s.ah`
 * s***icht*** `(I);cht` ! `s.icht`
    * : abs***icht*** `.ab.icht` * abs**i**cht `.ab-i`
    * : **an**s***icht*** `.an.icht`
    * : *auf*s***icht*** `AU.icht` * *auf*s**i**cht `AU-i`
    * : *ge*s***icht*** `G-icht`
    * : *hin*s***icht*** `hn.icht` * *hin*s**i**cht `hn-i`
 ...
 * : **f**ür*sorg* `f-s.o` * **f**ür*s****o****rg* `f,o`
 * : ***jug***end**f**ür*sorg* `.ug.ed<f-s.o` * ***jug***end**f**ür*s****o****rg* `.ug.ed.f,o` » `.ug.f,o` * `.ug-Ü.o`
 * : *ver**sorg* `E-s.o`
 * : *ver**sorg*er `E-s.o-er` * *ver**s****o****rg*er `E,o-er`
 * : *vor**sorg*e `O-s.o`
* sort `s.ot`
 * : sorte `s.ot.e` (E)
 * : sortier `s.ot.ir` (E)
 ...
 * *stalt* `-t`
    * : an*stalt* `.an-t`
    * : *ge**stalt* `G-t` = `-G-t` ~ `-G-a-t` ≠ *ge*hal***t***
    * : *ver*an*stalt* `E.an-t`
* stamm `st.am`
* stand ← steh
 ...
 * **v**ent `w` ! `w.et` E
    ...
    * : evtl. `.e-v-t-l`
    * : *in****v***entar `(I)w.ar` ! `IN.w.et.ar` (BSA) ~ `IN-t-ar`
       * : X `IN.w.et.ar.ir`
    * : *in***v**entur `(I)w-UR` ! `IN.w.et.UR` (BSA) ~ `IN-t-UR`
    * : **kon****v**ent*ion* `ko.w-o` ! `ko.w.et.iO` (E)
