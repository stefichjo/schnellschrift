 ...
 * h***ang*** → `:ang` ! `h.ang`
    ...
    * : anh***ang*** → `.an.ang`
    * : *vor*h***ang*** → `O.ang`
    * : *zu***samm**enh***ang*** → `Z-sa.ang` * `u-ang`
* **haupt** → `hau` E
 * : **häupt** → `häu` ! `h.äupt` (E)
* ***haus*** → `.aus` E
 * ***häus*** → `.äus` E
 ...
 * : umf***ang*****reich** → `.um<ang.r.ei` × `.um.r.ei` ~ `.um<eich`
* reif → `r.eif`
 * -***reif*** → `.eif`
...
DIE DURCHSTREICHUNG IST UEBERFLUESSIG, AUSSER BEI GANZEN WORTSTAEMMEN
